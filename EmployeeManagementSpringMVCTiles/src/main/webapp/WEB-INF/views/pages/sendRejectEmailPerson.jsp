...
<table>
		...
		<tr>
					<td><input type="text" name="subject" size="65" value="Sorry ! Your leave has been rejected." required="true"/></td>
				</tr> 
				<tr>
					<td><textarea cols="50" rows="5" name="message" required="true" >This is to inform you that your leave application for the mentioned period is rejected for some reasons.</textarea></td>
				</tr> 
